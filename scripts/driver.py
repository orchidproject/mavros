...
parser.add_option("--launch-altitude",dest="launch_altitude", default=5000, 
...
#            return False
	master.mav.command_long_send(master.target_system,
        ...
        if (state_msg.mode == "MANUAL"):
            ...
            return True
        rospy.loginfo ("SET MODE TO MANUAL")
        master.mav.set_mode_send(master.target_system, mavutil.mavlink.MAV_MODE_FLAG_MANUAL_INPUT_ENABLED, 0)
...
rospy.Service("apm/command", roscopter.srv.APMCommand, command_cb)
...
if opts.enable_rc_control:
    rospy.Subscriber("apm/send_rc", roscopter.msg.RC , send_rc_cb)
